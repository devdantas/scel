...
public class Emprestimo {
	...
	/*
	 * public Emprestimo(String ra, String dataEmprestimo, String dataDevolucao,
	 * String dataDevolucaoPrevista, String isbn) { super(); this.ra = ra;
	 * this.dataEmprestimo = dataEmprestimo; this.dataDevolucao = dataDevolucao;
	 * this.dataDevolucaoPrevista = dataDevolucaoPrevista; this.isbn = isbn; }
	 */
	public Emprestimo() {
		setDataEmprestimo();		
	}
